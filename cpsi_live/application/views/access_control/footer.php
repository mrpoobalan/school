    ...
    $('#add-user').validate({
        rules: {
            ...
            username: {
                remote: {
                    type: 'POST',
                    url: '<?= base_url("access_control/admin/username_check"); ?>',
                    data:
                            {
                                username: function()
                                {
                                    return $('#add-user :input[name="username"]').val();
                                }
                            }
                },
                minlength: 4,
        ...
        messages: {
            ...
            username: {
                ...
                remote: "The user name is already taken."
            },
...
//    $("#username").change(function() { // get value of your textbox on change, log to console
...
//                //console.log(resp);
//                if (resp) {
//                    alert('The username has already exists.\n' +
//                            'Please choice a another username.');
//                    $("#username").val('');
//                    $("#username").focus();
//                }
//            }
