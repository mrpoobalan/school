    ...
    <section class="page">
        ...
        <fieldset class="new-section">
            ...
            <section>
                ...
                <?php //echo $wiz_03->release1 . 'test'; ?>

                <span class="inline"><input type="radio" name="release1" value="yes" onclick="showvalue51(this.value)"  id="release1yes" <?= $wiz_03->release1 == 'yes' || $wiz_03->release1 == 'release1yes' ? ' checked ' : ''; ?>  /> <label for="release1"><span></span>Yes</label></span>
                <span class="inline"><input type="radio" name="release1" value=""  onclick="showvalue51(this.value)" id="release1no"  <?= $wiz_03->release1 == '' || $wiz_03->release1 == 'release1no' ? ' checked ' : ''; ?> /> <label for="release1"><span></span>No</label></span>
                <div id="hidename51">
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        var checkboxrel2 = $("input[name='release1']").val();
        //alert(checkboxrel2);
        if (checkboxrel == 'no') {
