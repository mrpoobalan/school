                ...
                <fieldset class="twocol">
                    ...
                    <section>
                        ...
                        <span class="inline"><input type="checkbox" name="vent_depend_dependent" onclick="showvalue13();
                                showvent1();" id="vent_depend_dependent" value="Ventilator Dependent"   <?php echo!empty($wiz_11->vent_depend_dependent) ? ' checked ' : '' ?> /><label for="vent_depend_dependent"><span></span> Ventilator Dependent</label></span>
                        <span class="inline"><input type="checkbox" name="vent_depend_assist" id="vent_depend_assist" onclick="showvalue13();
                                showvent1();" value="Ventilator Assist"   <?php echo!empty($wiz_11->vent_depend_assist) ? ' checked ' : '' ?> /><label for="vent_depend_assist"><span></span> Ventilator Assist</label></span>
