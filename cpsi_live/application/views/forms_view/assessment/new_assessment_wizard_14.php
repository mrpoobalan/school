        ...
        <fieldset class="new-section">
            ...
            <div class="hide367" >
                ...
                <section class="two-col">
                    ...
                    <span class="inline"><input type="radio" name="assist_tech" value="yes" onclick="showvalue355(this.value)" id="assist_tech" <?php echo $wiz_14->assist_tech == "yes" ? ' checked ' : '' ?>/><label for="assist-tech-yes"><span></span>Yes</label></span>
                    <span class="inline"><input type="radio" name="assist_tech" value="" id="assist_tech_no" onclick="showvalue355(this.value)" <?php //echo $wiz_14->assist_tech == "" ? ' checked ' : ''                    ?> /><label for="assist-tech-no"><span></span>No</label></span>
                    <div id='hidename355'>
                ...
                <section class="two-col">
                    ...
                    <span class="inline"><input type="radio" name="accomodations" value="yes" id="accomodations" onclick="showvalue356(this.value)" <?php echo $wiz_14->accomodations == "yes" ? ' checked ' : '' ?>/><label for="accomodations"><span></span>Yes</label></span>
                    <span class="inline"><input type="radio" name="accomodations" value="" id="accomodations_no" onclick="showvalue356(this.value)" <?php //echo isset($wiz_14->accomodations) && $wiz_14->accomodations == "" ? ' checked ' : ''               ?> /><label for="accomodations"><span></span>No</label></span>
                    <div id='hidename356'>
            ...
            <div class="hide16">
                ...
                <fieldset>
                    ...
                    <section>
                        ...
                        <span><input type="checkbox" name="med_bus_selfmed" id="med_bus_selfmed" value="Self Carries/Unable to Self Administer" <?php echo!empty($wiz_14->med_bus_selfmed) ? ' checked ' : '' ?> /><label for="med_bus_selfmed"><span></span> Self Carries/Unable to Self Administer</label></span>
...
<script type="text/javascript">
    $(document).ready(function() {
        //Deafult accomodations and assist_tech
        var asscheck = $('input[name=assist_tech]').is(':checked');
        var acccheck = $('input[name=accomodations]').is(':checked');
        if (asscheck == false) {
            $("#assist_tech_no").attr('checked', 'checked');
        }
        if (acccheck == false) {
            $("#accomodations_no").attr('checked', 'checked');
        }
