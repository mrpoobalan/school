...
<!--<input type="text" id="dob" name="dob" required value="<?php //echo date('m/d/Y', $wiz01->dob);                                                                       ?>"/>-->
                <?php
                ...
                <section class="">
                    <div id="sheepItForm" style="float:left;">
                        <div id="sheepItForm_template">
                            ...
                            <input readonly id="sheepItForm_#index#_contact" name="contactattempt[]" type="text" class="generate_datepic"/>
...
if (!empty($contact_array)):
    ...
    foreach ($contact_array as $key => $val) {
        if ($val <> '1970-01-01') {
            ?>
                    $('#sheepItForm_<?php echo $key; ?>_contact').val('<?php echo isset($val) ? date('m-d-Y', strtotime($val)) : ''; ?>');
            <?php
        }
    } endif;
?>
