    ...
    <section class = "page healthform viewsh1 noshadow">
        ...
        <div class="first-divs">
            ...
            <div class="section-div">
                ...
                <p class="rightadjust"><label >Address:</label> <?php echo ($wiz01->street != '' || $wiz01->city != '' || $wiz01->zip != '') ? $wiz01->street . " " . $wiz01->city . " " . $wiz01->zip : 'N/A'; ?>
            ...
            <div class="section-div">
                ...
                <p class="leftadjust"><label>Specialist Name:</label> <?php echo $wiz03->specialist1 == '' ? 'N/A' : $wiz03->specialist1; ?></p>
                <p class="rightadjust"><label>Type of Physician:</label> <?php echo $wiz03->type1 == '' ? 'N/A' : $wiz03->type1; ?></p>
                <p class="leftadjust"><label>Last Exam:</label> <?php echo $wiz03->lastexam2 == '' ? 'N/A' : $wiz03->lastexam2; ?></p>
                <p class="rightadjust"><label>Next Exam:</label> <?php echo $wiz03->nextexam2 == '' ? 'N/A' : $wiz03->nextexam2; ?></p>
                <p class="leftadjust"><label>Phone:</label> <?php echo $wiz03->phone2 == '' ? 'N/A' : $wiz03->phone2; ?></p>
                <p class="rightadjust"><label>Fax:</label> <?php echo $wiz03->fax2 == '' ? 'N/A' : $wiz03->fax2; ?></p>
                <p class="leftadjust"><label>Specialist Release:</label> <?php echo $wiz03->release2 == '' ? 'N/A' : $wiz03->release2; ?></p>
                <p class="rightadjust"><label>list or explain:</label> <?php echo $wiz03->describe_sheepItForm == '' ? 'N/A' : $wiz03->describe_sheepItForm; ?></p>
                <p class="leftadjust"><label>Release Expiration:</label> <?php echo $wiz03->release_exp2 == '' ? 'N/A' : $wiz03->release_exp2; ?></p>
                <div class="divclearboth"></div>
            </div>
            ...
            if (empty($wiz03->hide2)):
                ...
                <div class="section-div">
                    ...
                    <p class="leftadjust"><label>Name:</label> <?php echo $wiz03->name1 == '' ? 'N/A' : $wiz03->name1; ?></p>
                    <p class="rightadjust"><label>Agency Name:</label> <?= $wiz03->agname1 == '' ? 'N/A' : $wiz03->agname1; ?> </p>
                    <p class="leftadjust"><label>Case Manager:</label> <?= $wiz03->cashman1 == '' ? 'N/A' : $wiz03->cashman1; ?> </p>
                    <p class="rightadjust"><label>Contact Info:</label> <?php echo $wiz03->agencyphone1 == '' ? 'N/A' : $wiz03->agencyphone1; ?></p>
                    <p class="leftadjust"><label>Release:</label> <?php echo $wiz03->agencyrelease1 == '' ? 'N/A' : $wiz03->agencyrelease1; ?></p>
                    <div class="divclearboth"></div>
                </div>
                <?php
            endif;
            ...
            if (empty($wiz04->hide3)):
                ...
                <div class="section-div">
                    ...
                    <p class="leftadjust"><label>Medication Name:</label> <?php echo $wiz04->med1 == '' ? 'N/A' : $wiz04->med1; ?></p>
                    <p class="rightadjust"><label>Dosage:</label> <?php echo $wiz04->dose1 == '' ? 'N/A' : $wiz04->dose1; ?></p>
                    <p class="leftadjust"><label>Time/Frequency:</label> <?php echo $wiz04->time1 == '' ? 'N/A' : $wiz04->time1; ?></p>
                    <p class="rightadjust"><label>Route:</label> <?php echo $wiz04->route1 == '' ? 'N/A' : $wiz04->route1; ?></p>
                    <p class="leftadjust"><label>Taken at School:</label> <?php echo $wiz04->taken1_school == '' ? 'N/A' : $wiz04->taken1_school; ?></p>
                    <p class="rightadjust"><label>Taken at Home:</label> <?php echo $wiz04->taken1_home == '' ? 'N/A' : $wiz04->taken1_home; ?></p>
                    <div class="divclearboth"></div>
                </div>
                <?php
            endif;
            ...
            if (empty($wiz04->hide4)):
                ...
                <div class="section-div">
                    ...
                    <p class="leftadjust"><label>Medication Name:</label> <?php echo $wiz04->prnmed1 == '' ? 'N/A' : $wiz04->prnmed1; ?></p>
                    <p class="rightadjust"><label>Dosage:</label> <?php echo $wiz04->prndose1 == '' ? 'N/A' : $wiz04->prndose1; ?></p>
                    <p class="leftadjust"><label>Time/Frequency:</label> <?php echo $wiz04->prntime1 == '' ? 'N/A' : $wiz04->prntime1; ?></p>
                    <p class="rightadjust"><label>Route:</label> <?php echo $wiz04->prnroute1 == '' ? 'N/A' : $wiz04->prnroute1; ?></p>
                    <p class="leftadjust"><label>Taken at School:</label> <?php echo $wiz04->prntaken1_school == '' ? 'N/A' : $wiz04->prntaken1_school; ?></p>
                    <p class="rightadjust"><label>Taken at Home:</label> <?php echo $wiz04->prntaken1_home == '' ? 'N/A' : $wiz04->prntaken1_home; ?></p>
                    <p class="leftadjust"><label>Taken In Emergency:</label> <?php echo $wiz04->prntaken1_emergency == '' ? 'N/A' : $wiz04->prntaken1_emergency; ?></p>
            ...
            if (empty($wiz05->hide502)):
                ...
                ?></label>
                    ...
                    <p class="leftadjust"><label>Treatment Order:</label> <?php echo $wiz05->treatment1 == '' ? 'N/A' : $wiz05->treatment1; ?></p>
                    <p class="rightadjust"><label>Frequency:</label> <?php echo $wiz05->frequency1 == '' ? 'N/A' : $wiz05->frequency1; ?></p>
                    <!--<label>Peformed</label>-->
                    <?php if ($wiz05->performed_school1 != '') { ?>
                        <p class="leftadjust"><label>Performed:</label> <?php echo $wiz05->performed_school1 == 'no' ? 'At Home' : 'At School'; ?></p>
                    <?php } ?>
                    <p class="rightadjust"><label>Person Performing:</label> <?php echo $wiz05->person1 == '' ? 'N/A' : $wiz05->person1; ?></p>
                    <div class="divclearboth"></div>
                </div>
                <?php
            endif;
            ...
            if (empty($wiz05->hide6)):
                ...
                <div class="section-div">
                    ...
                    <p class="leftadjust"><label>Allergic to:</label> <?php echo $wiz05->allergy1 == '' ? 'N/A' : $wiz05->allergy1; ?></p>
                    <p class="rightadjust"><label>Reaction:</label> <?php echo $wiz05->reaction1 == '' ? 'N/A' : $wiz05->reaction1; ?></p>
                    <p class="leftadjust"><label>Touch/Contact:</label> <?php echo $wiz05->sensitivity1_touch == '' ? 'N/A' : $wiz05->sensitivity1_touch; ?></p>
                    <p class="rightadjust"><label>Ingestion:</label> <?php echo $wiz05->sensitivity1_ingest == '' ? 'N/A' : $wiz05->sensitivity1_ingest; ?></p>
                    <p class="leftadjust"><label>Air:</label> <?php echo $wiz05->sensitivity1_air == '' ? 'N/A' : $wiz05->sensitivity1_air; ?></p>
                    <p class="rightadjust"><label>Sting/Bite:</label> <?php echo $wiz05->sensitivity1_sting == '' ? 'N/A' : $wiz05->sensitivity1_sting; ?></p>
                    <p class="leftadjust"><label>Epinephrine Auto-Injection:</label> <?php echo $wiz05->treatment1_epi == '' ? 'N/A' : $wiz05->treatment1_epi; ?></p>
                    <p class="rightadjust"><label>Antihistamine:</label> <?php echo $wiz05->treatment1_antihistamine == '' ? 'N/A' : $wiz05->treatment1_antihistamine; ?></p>
                    <p class="leftadjust" id="bgplan"><label>How was the allergy diagnosed?</label> <?php echo $wiz05->diagnosed1 == '' ? 'N/A' : $wiz05->diagnosed1; ?></p>
                    <p class="rightadjust"><label>Last Event:</label> <?php echo $wiz05->lastevent1 == '' ? 'N/A' : $wiz05->lastevent1; ?></p>
                    <p class="leftadjust"><label>Additional Comments:</label> <?php echo trim($wiz05->addtnlcomments1) == '' ? 'N/A' : $wiz05->addtnlcomments1; ?></p>
                    <div class="divclearboth"></div>
                </div>
                <?php
            endif;
            ...
            <?php if (empty($wiz06->hide8)): ?>
                ...
                <div class="section-div">
                    ...
                    <p class="rightadjust"><label>Shunt:</label> <?php echo $wiz06->shunt == '' ? 'N/A' : $wiz06->shunt ?></p>
                    <p class="leftadjust"><label>Shunt Type:</label> <?php echo trim($wiz06->shunt_type) == '' ? 'N/A' : $wiz06->shunt_type; ?></p>
                    ...
                    <p class="rightadjust"><label>Additional Comments:</label> <?php echo trim($wiz06->seizure_comments) == '' ? 'N/A' : $wiz06->seizure_comments ?> </p>
            ...
            <?php if (empty($wiz08->hide10)): ?>
                ...
                <div class="section-div">
                    ...
                    <p class="rightadjust"><label>Additional Comments:</label> <?php echo trim($wiz08->cardiac_addtnl) == '' ? 'N/A' : $wiz08->cardiac_addtnl; ?> </p>
                    <div class="divclearboth"></div>
                </div>
            <?php endif; ?>
            <?php if (empty($wiz09->hide11)): ?>
                ...
                <div class="section-div">
                    <p class="leftadjust"><label>Have sympoms prevented activities?</label>
            ...
            <?php if (empty($wiz11->hide122)): ?>
                ...
                <div class="section-div">
                    ...
                    <p class="rightadjust"><label>Additional Ventilator information:</label> <?php echo $wiz11->addtnl_vent == '' ? 'N/A' : $wiz11->addtnl_vent; ?> </p>
                ...
                <div class="section-div">
                    ...
                    <p class="rightadjust"><label>Additional Comments:</label> <?php echo trim($wiz11->oxy_addtnl) == '' ? 'N/A' : $wiz11->oxy_addtnl; ?> </p>
                    <div class="divclearboth"></div>
                </div>
            <?php endif; ?>
            ...
            <?php if (empty($wiz14->hide367)): ?>
                <div class="section-div">
                    ...
                    <?php if (isset($wiz14->hide367)): ?>
                        <p class="leftadjust"><label>ITP:</label> <?php echo $wiz14->edustatus == "" ? 'Nil' : $wiz14->edustatus; ?> </p>
                    <?php endif; ?>
            ...
            <?php if (empty($wiz16->hide188)): ?>
                ...
                foreach ($wiz16->planname7 as $key => $prnMedications):
                    ...
                    <div class="section-div">
                        <?php
                        if ($wiz16->planname1 == '' && $wiz16->planname1 == '' && $wiz16->planname1 == '' &&
                                $wiz16->planname1 == '' && $wiz16->planname1 == '' && $wiz16->planname1 == ''):
                            ?>
                            <label>Emergency Action Plans </label>
                        <?php endif; ?>
...
//                    alert(spl);
                    if (spl[1].indexOf("N/A") != -1 || spl[1].indexOf("No") != -1 || spl[1].indexOf("no") != -1) {
