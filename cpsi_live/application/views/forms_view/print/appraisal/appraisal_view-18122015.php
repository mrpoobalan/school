        ...
        <div id="bg-text">
            <div class="first-divs">
                ...
                <div class="section-div">
                    ...
                    <p class="rightadjust"><label> Idle:</label> <?php echo in_array('None', $insurance) ? 'None' : 'N/A'; ?> </p>
                ...
                <?php if (isset($wiz02)) : ?>
                    <div class="section-div">
                        ...
                        <p class="rightadjust"><label>Details:</label> <?php echo $wiz02->newdiagnosis == '' ? 'N/A' : rtrim($wiz02->newdiagnosis, ','); ?></p>
                        <div class="divclearboth"></div>
                    </div>
                    ...
                    <div class="section-div">
                        ...
                        <p class="leftadjust"><label>Milestones List:</label> <?php echo $wiz02->describemilestones == '' || $wiz02->milestones == 'milestoneyes' ? 'N/A' : $wiz02->describemilestones; ?></p>
                ...
                <?php if (empty($wiz03->hide39)): ?>
                    ...
                    <div class="section-div">
                        ...
                        <p class="rightadjust"><label>More than 2x/week:</label> <?= $wiz03->night_symptoms_twice == '' ? 'N/A' : 'Yes'; ?> </p>
                        <p class="leftadjust"><label>Night symptoms twiceplus:</label> <?= $wiz03->night_symptoms_twiceplus == '' ? 'N/A' : 'Yes'; ?> </p>
                        <p class="rightadjust"><label>Every Day:</label> <?= $wiz03->night_symptoms_always == '' ? 'N/A' : 'Yes'; ?> </p>
                    ...
                    <div class="section-div">
                        ...
                        <p class="rightadjust"><label>Student self_carries MDI:</label> <?= $wiz03->selfmdi <> 'selfmdiyes' ? 'No' : 'Yes'; ?> </p>
                ...
                <?php if (empty($wiz04->hide12)): ?>
                    <div class="section-div">
                        <label>Respiratory _ Oxygen/Tracheostomy/Ventilation Requirements</label>
                        ...
                        <?php if ($wiz04->ox_route_nasal <> '' || $wiz04->ox_route_trach <> '' || $wiz04->ox_route_mask <> ''): ?>
                            ...
                            <p class="rightadjust"><label> Mask/Non_Rebreather:</label> <?= $wiz04->ox_route_mask == '' ? 'N/A' : 'Yes'; ?> </p>
                            <?php
                        endif;
                    ...
                    <div class="section-div">
                        ...
                        <p class="rightadjust"><label>Thermo_vent:</label> <?= $wiz04->thermo == '' ? 'N/A' : $wiz04->thermo ?> </p>
                ...
                <?php if (empty($wiz06->hide15)): ?>
                    ...
                    <div class="section-div">
                        <h1>Emergency Kit</h1>
                        Hypoglycemia<p class="leftadjust"><label>In HR:</label> <?php echo $wiz06->emer_kit_hr == '' ? 'N/A' : $wiz06->emer_kit_hr; ?></p>
                    ...
                    <div class="section-div">
                        ...
                        <p class="rightadjust"><label>Lock Down Insulin Orders:</label> <?php echo $wiz06->lockdowndesc == '' ? 'N/A' : $wiz06->lockdowndesc; ?></p>
                        <div class="divclearboth"></div>
                    </div>
                    <div class="section-div">
                        <h1>Additional Comments</h1>
                ...
                <?php if (empty($wiz06->hide335)): ?>
                    <div class="section-div">
                        ...
                        <p class="leftadjust"><label>Do the symptoms or treatment for symptoms impact your childâ€™s daily schedule or routine? </label> <?= $wiz06->routine == '' ? 'N/A' : $wiz06->routine ?> </p>
                ...
                <?php if (empty($wiz06->hide367)): ?>
                    <div class="section-div">
                        ...
                        <p class="leftadjust"><label>Status:</label> <?php echo $wiz06->edustatus <> '' ? strtoupper($wiz06->edustatus) : "Nil"; ?> </p>
                ...
                <?php if (empty($wiz06->hide16)): ?>
                    ...
                    <div class="section-div">
                        ...
                        <p class="rightadjust"><label>Self Carries/Unable to Self_Administer:</label> <?php echo $wiz06->med_bus_selfmed == '' ? 'N/A' : $wiz06->med_bus_selfmed; ?></p>
