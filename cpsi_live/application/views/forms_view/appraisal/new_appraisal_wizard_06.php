        ...
        <div class="hide15">
            <fieldset class="wide threecol">
                <section>
                    ...
                    <span class="inline"><input type="radio" name="gluc_test" id="gluc_test_yes" value="Yes" <?= !empty($wizardData->{'gluc_test'}) ? ' checked ' : ''; ?> /> <label><span for="gluc_test_yes"></span> Yes</label></span>
                    <span class="inline"><input type="radio" name="gluc_test" id="gluc_test_no" value="" <?= empty($wizardData->{'gluc_test'}) ? ' checked ' : ''; ?> /> <label><span for="gluc_test_no"></span> No</label></span>
            ...
            <fieldset>
                ...
                <section>
                    ...
                    <span><input type="checkbox" name="dose_pump" id="dose_pump" value="Pump/Pod calculations" <?php echo!empty($wizardData->dose_pump) ? ' checked ' : '' ?> /> <label for="dose_pump"><span></span> Pump/Pod Calculations</label></span>
                </section>
            </fieldset>
            <fieldset class="threecol">
                <section>
...
<!--                <section>
            ...
            <fieldset class="threecol">
                ...
                <section>
                    ...
                    <span><input type="checkbox" name="kit_contents_snacks" id="kit_contents_snacks" value="Snacks" <?= !empty($wizardData->kit_contents_snacks) ? ' checked ' : ''; ?> /> <label for="kit_contents_snacks"><span></span> Snack(s)</label></span>
...
<fieldset class="new-section">
    ...
    <div class="hide367">
        ...
        <section>
            ...
            <span class="inline"><input type="checkbox" name="edustatus2[]" value="eduregular" id="edustatus2-regular" <?= !empty($wizardData->eduregular) || !empty($wizardData->edustatus2_regular) || in_array('eduregular', $wizardData->edustatus2) ? ' checked ' : ''; ?> /> <label for="edustatus2-regular"><span></span>Regular Education</label></span>
            <span class="inline"><input type="checkbox" name="edustatus2[]" value="eduIEP" id="edustatus2-iep" <?= !empty($wizardData->eduiep) || !empty($wizardData->edustatus2_iep) || in_array('eduIEP', $wizardData->edustatus2) ? ' checked ' : ''; ?>/> <label for="edustatus2-iep"><span></span>IEP</label></span>
            <span class="inline"><input type="checkbox" name="edustatus2[]" value="edu504" id="edustatus2-504" <?= !empty($wizardData->edu504) || !empty($wizardData->edustatus2_504) || in_array('edu504', $wizardData->edustatus2) ? ' checked ' : ''; ?>/> <label for="edustatus2-504"><span></span>504</label></span>
        </section>
        <section>
...
<!--        <section>
            ...
            <span class="inline"><input type="radio" name="assistant[]" value="assistantyes" id="assistant-yes" <?= $wizardData->assistant == 'assistantyes' ? ' checked ' : ''; ?> /> <label for="assistant-yes"><span></span>Yes</label></span>
        ...
        <section>
            <label for="assistant">Current Individual Educational Assistant?</label>
            <span class="inline"><input type="radio" name="assistant[]" value="assistantyes" id="assistant-yes" <?= $wizardData->assistant{0} == 'assistantyes' ? ' checked ' : ''; ?> /> <label for="assistant-yes"><span></span>Yes</label></span>
            <span class="inline"><input type="radio" name="assistant[]" value="assistantno" id="assistant-no" <?= $wizardData->assistant{0} == 'assistantno' ? ' checked ' : ''; ?>/> <label for="assistant-no"><span></span>No</label></span>
        </section>
        <section>
            ...
            <div class="check-group">
                <span><input type="checkbox" name="eduservices[]" value="occupationaltherapy" id="eduservices-occupational" <?= !empty($wizardData->occupationaltherapy) || !empty($wizardData->eduservices_occupational) || in_array('occupationaltherapy', $wizardData->eduservices) ? ' checked ' : ''; ?> /> <label for="eduservices-occupational"><span></span>Occupational Therapy</label></span>
                <span><input type="checkbox" name="eduservices[]" value="physicaltherapy" id="eduservices-physical" <?= !empty($wizardData->physicaltherapy) || !empty($wizardData->eduservices_physical) || in_array('physicaltherapy', $wizardData->eduservices) ? ' checked ' : ''; ?> /> <label for="eduservices-physical"><span></span>Physical Therapy</label></span>
                <span><input type="checkbox" name="eduservices[]" value="speechlanguage" id="eduservices-speech" <?= !empty($wizardData->speechlanguage) || !empty($wizardData->eduservices_speech) || in_array('speechlanguage', $wizardData->eduservices) ? ' checked ' : ''; ?> /> <label for="eduservices-speech"><span></span>Speech/Language</label></span>
                <span><input type="checkbox" name="eduservices[]" value="counseling" id="eduservices-counseling" <?= !empty($wizardData->counseling) || !empty($wizardData->eduservices_counseling) || in_array('counseling', $wizardData->eduservices) ? ' checked ' : ''; ?> /> <label for="eduservices-counseling"><span></span>Counseling</label></span>
                <span><input type="checkbox" name="eduservices[]" value="adaptivepe" id="eduservices-pe" <?= !empty($wizardData->adaptivepe) || !empty($wizardData->eduservices_pe) || in_array('adaptivepe', $wizardData->eduservices) ? ' checked ' : ''; ?> /> <label for="eduservices-pe"><span></span>Adaptive PE</label></span>
            </div>
        </section>
        <div style="clear:both"></div>
        <section>
            <span><input type="checkbox" name="offlocation[]" value="offlocation_hospital" id="offlocation-hospital" <?= !empty($wizardData->offlocation_hospital) || in_array('offlocation_hospital', $wizardData->offlocation) ? ' checked ' : ''; ?> /> <label for="offlocation-hospital"><span></span>Home Hospital Teaching</label></span>
            <span><input type="checkbox" name="offlocation[]" value="offlocation_home" id="offlocation-home" <?= !empty($wizardData->offlocation_home) || in_array('offlocation_home', $wizardData->offlocation) ? ' checked ' : ''; ?> /> <label for="offlocation-home"><span></span>Concurrent Home Teaching</label></span>
        ...
        <section class="two-col">
            <?php //echo $wizardData->assisttech;      ?>
            <label for="assisttech">Assistive Technology</label>
            <span class="inline"><input type="radio" name="assisttech" value="assisttechyes" id="assist-tech-yes" onclick="showvalue358(this.value)" <?= !empty($wizardData->assisttech) && ($wizardData->assisttech == 'assisttechyes') ? ' checked ' : ''; ?> /><label for="assist-tech-yes"><span></span>Yes</label></span>
            <span class="inline"><input type="radio" name="assisttech" value="assisttechno" id="assist-tech-no" onclick="showvalue358(this.value)"  <?= ($wizardData->assisttech == 'assisttechno') ? ' checked ' : ' '; ?> /><label for="assist-tech-no"><span></span>No</label></span>
            <div id="hidename358">
        ...
        <section class="two-col">
            ...
            <span class="inline"><input type="radio"  name="accomodations" value="accomodationsyes" id="accomodations-yes" onclick="showvalue359(this.value)" <?= !empty($wizardData->accomodations) && $wizardData->accomodations == 'accomodationsyes' ? ' checked ' : ''; ?> /><label for="accomodations-yes"><span></span>Yes</label></span>
            <span class="inline"><input type="radio" name="accomodations" value="accomodationsno" id="accomodations-no" onclick="showvalue359(this.value)" <?= $wizardData->accomodations == 'accomodationsno' ? ' checked ' : ''; ?>/><label for="accomodations-no"><span></span>No</label></span>
            <div id="hidename359">
...
<fieldset class="new-section">
    ...
    <div class="hide115" style="margin-left: 10px;">
        ...
        <span class="inline"><input type="radio" name="ihp" id="ihp" value="no" onclick="showvals(this)"  <?php echo ($wizardData->ihp == 'no' || $wizardData->ihp == '') ? 'checked' : ' '; ?>/><label for="ihp-no"><span></span> No</label></span>
...
<script type="text/javascript">
    $(document).ready(function() {
        //accomodations and assisttech default to no
        var acccheck = $('input[name=accomodations]').is(':checked');
        var asscheck = $('input[name=assisttech]').is(':checked');
        if (asscheck == false) {
            $("#assist-tech-no").attr('checked', 'checked');
        }
        if (acccheck == false) {
