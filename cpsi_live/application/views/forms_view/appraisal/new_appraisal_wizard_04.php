        ...
        <div class="hide12">
            <fieldset class="twocol">
                ...
                <section>
                    ...
                    <span class="inline"><input type="checkbox" name="vent_depend_dependent" onclick="showvalue13();
                            showvent();" id="vent_depend_dependent" value="Ventilator Dependent"   <?php echo!empty($wizardData->vent_depend_dependent) ? ' checked ' : '' ?> /><label for="vent_depend_dependent"><span></span> Ventilator Dependent</label></span>
                    <span class="inline"><input type="checkbox" name="vent_depend_assist" id="vent_depend_assist" onclick="showvalue13();
                            showvent();" value="Ventilator Assist"   <?php echo!empty($wizardData->vent_depend_assist) ? ' checked ' : '' ?> /><label for="vent_depend_assist"><span></span> Ventilator Assist</label></span>
            ...
            <section>
                ...
                <span><input type="checkbox" name="ox_route_mask" id="ox_route_mask" value="Mask/Non_Rebreather" <?= !empty($wizardData->{'ox_route_mask'}) ? ' checked ' : ''; ?> /><label for="ox_route_mask"><span></span> Mask/Non-Rebreather</label></span>
        ...
        <div class="hide133">
            ...
            <fieldset>
                <section>
                    ...
                    <div id="hidename303">
                        <label for="sco_last">Last X-Ray/Exam</label>
                ...
                <section>
                    ...
                    <div id="hidename330">
                        <label for="hip_last">Last X-Ray/Exam</label>
                        <input type="text" id="hip_last" name="hip_last"  value="<?= !empty($wizardData->hip_last) ? $wizardData->hip_last : ''; ?>" />
                    </div>
                ...
                <section>
                    ...
                    <div id="hidename14" style="display: none">
                        ...
                        <span class="inline"><input type="radio" name="pt_where" id="pt_where_home" value="Home" <?= ($wizardData->{'pt_where'} == 'Home') ? ' checked ' : ''; ?> /><label for="pt_where_home"><span></span> Home</label></span>
                        <span class="inline"><input type="radio" name="pt_where" id="pt_where_school" value="School" <?= ($wizardData->{'pt_where'} == 'School') ? ' checked ' : ''; ?> /><label for="pt_where_school"><span></span> School</label></span>
                        <span class="inline"><input type="radio" name="pt_where" id="pt_where_both" value="Both" <?= ($wizardData->{'pt_where'} == 'Both') ? ' checked ' : ''; ?> /><label for="pt_where_both"><span></span> Both</label></span>
                    </div>
                </section>
            </fieldset>
            <fieldset>
...
<script type="text/javascript">
    //alert($('input[name=ventilation]:checked', '#appraisal4').val());
    var depend = document.getElementById('vent_depend_dependent').checked;
    var assist = document.getElementById('vent_depend_assist').checked;
    if (depend == true || assist == true) {
        document.getElementById('vent_co_info').style.display = 'block';
    } else {
        document.getElementById('vent_co_info').style.display = 'none';
    }
    function showvent() {
        var depend = document.getElementById('vent_depend_dependent').checked;
        var assist = document.getElementById('vent_depend_assist').checked;
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $("#vent_co").rules("add", {
            required: true,
            messages: {
                required: "<span class='errorchk7'>Error: " + "Field is required" + "</span>"
            }
        });
        $("#vent_contact").rules("add", {
            required: true,
            messages: {
                required: "<span class='errorchk7'>Error: " + "Field is required" + "</span>"
            }
        });
        $("#vent_assist").rules("add", {
            required: true,
            messages: {
                required: "<span class='errorchk7'>Error: " + "Field is required" + "</span>"
            }
...
//            var ckbox = ($('input[name=hide12]:checked', '#appraisal4').val());
        ...
        $('#appraisal4').submit(function() {
            ...
            // alert($fields3.length);
            if ($fields3.length == 1) {
                if ($suction == "Yes" && ckbox != 'on' && $fields1.length == 0 && $fields2.length == 0) {
                    $('.errorchk7').remove();
