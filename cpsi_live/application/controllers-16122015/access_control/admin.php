...
//                echo "</pre>";
                if ($user_role->level <= 20 && $acct_role == "Nurse Supervisor"):
                    $nurse_supervisor = $programManager[0]->first_name . " " . $programManager[0]->last_name;
                    $program_manager = $manage_by_list_ns->first_name . " " . $manage_by_list_ns->last_name;
                else:
                    $nurse_supervisor = $manage_by_list_ns->first_name . " " . $manage_by_list_ns->last_name;
                    $program_manager = $programManager[0]->first_name . " " . $programManager[0]->last_name;
                endif;
            }
