...
//            },
    ...
    $('#appraisal4').validate({
        rules: {
            ...
            vent_assist: {
                required: function() {
                    return $('input[name=vent_depend_assist]:checked', '#appraisal4').val() == 'Ventilator Assist';
                }
            },
            vent_co: {
                required: function() {
                    return $('input[name=ventilation]:checked', '#appraisal4').val() == "" || $('input[name=vent_depend_dependent]:checked', '#appraisal4').val() != undefined || $('input[name=vent_depend_assist]:checked', '#appraisal4').val() != undefined;
                },
                lettersonly: true
