...
<body>
    <section class = "page">
        ...
        <div class="section-divs">
            ...
            <p>&nbsp;</p>
            <p><label> DOB:</label> <?php echo date_change($status['birth_date']); ?> </p>
            <p>&nbsp;</p>
...
<?php endforeach; ?>
            ...
            <div class="section-div">
                ...
                <p class="leftadjust"><label>Contact Attempts</label><?php echo $wiz01->contactattempt1 == '' ? 'N/A' : rtrim($wiz01->contactattempt1, ','); ?></p>
                <div class="divclearboth"></div>
            </div>
            <div class="section-div">
                <label>Medical Diagnosis:</label>
                <p class="rightadjust"><label>Medical Diagnosis:</label> <?php echo $wiz02->newdiagnosis == '' ? 'N/A' : rtrim($wiz02->newdiagnosis, ','); ?></p>
                <div class="divclearboth"></div>
            </div>
            ...
            <div class="section-div">
                ...
                <p class="rightadjust"><label>Developmental Milestones Met:</label> <?php echo $wiz02->milestones <> 'milestoneyes' ? 'None' : $wiz02->milestones; ?></p>
...
<?php if ($wiz04->ox_route_nasal <> '' || $wiz04->ox_route_trach <> '' || $wiz04->ox_route_mask <> ''): ?>
                    ...
                    <p class="rightadjust"><label> Mask/Non_Rebreather:</label> <?= $wiz04->ox_route_mask == '' ? 'N/A' : $wiz04->ox_route_mask ?> </p>
                <?php
                endif;
...
<?php if ($wiz06->emer_kit_hrs <> '' || $wiz06->emer_kit_class <> '' || $wiz06->emer_kit_carry <> ''): ?>
                    <p class="leftadjust"><label style="color:#000;">Emergency Kit</label>&nbsp;</p>
