        ...
        <fieldset class="new-section">
            ...
            <div class="hide8">
                ...
                <section class="two-col">
                    ...
                    <span class="inline"><input type="radio" name="shunt" value="" onclick="showvalue5()" id="shunt" <?php echo empty($wiz_06->shunt) ? ' checked ' : '' ?> /> <label for="shunt-no"><span></span>No</label></span>
