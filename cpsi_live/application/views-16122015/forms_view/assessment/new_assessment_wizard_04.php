...
{
    ?>
            $('#sheepItForm_<?php echo $key1 ?>_med').val('<?php echo $value1; ?>');
<?php } ?>
<?php
foreach ($wiz_04->dose1 as $key2 => $value2)
{
    ?>
            $('#sheepItForm_<?php echo $key2 ?>_dos').val('<?php echo $value2; ?>');
<?php } ?>
<?php
foreach ($wiz_04->route1 as $key3 => $value3)
{
    ?>
            $('#sheepItForm_<?php echo $key3 ?>_route').val('<?php echo $value3; ?>');
<?php } ?>
<?php
foreach ($wiz_04->time1 as $key4 => $value4)
{
    ?>
            $('#sheepItForm_<?php echo $key4 ?>_time').val('<?php echo $value4; ?>');
<?php } ?>
...
{
    ?>
            $('#sheepItForm1_<?php echo $key1 ?>_prnmed').val('<?php echo $value1; ?>');
<?php } ?>
<?php
foreach ($wiz_04->prndose1 as $key2 => $value2)
{
    ?>
            $('#sheepItForm1_<?php echo $key2 ?>_prndos').val('<?php echo $value2; ?>');
<?php } ?>
<?php
foreach ($wiz_04->prnroute1 as $key3 => $value3)
{
    ?>
            $('#sheepItForm1_<?php echo $key3 ?>_prnroute').val('<?php echo $value3; ?>');
<?php } ?>
<?php
foreach ($wiz_04->prntime1 as $key4 => $value4)
{
    ?>
            $('#sheepItForm1_<?php echo $key4 ?>_prntime').val('<?php echo $value4; ?>');
<?php } ?>
