...
{
    ?>
            $('#sheepItForm_<?php echo $key1 ?>_allergy').val('<?php echo $value1; ?>');
<?php } ?>
<?php
foreach ($wiz_05->reaction1 as $key2 => $value2)
{
    ?>
            $('#sheepItForm_<?php echo $key2 ?>_reaction').html('<?php echo $value2; ?>');
<?php } ?>
<?php
foreach ($wiz_05->addtnlcomments1 as $key2 => $value2)
{
    ?>
            $('#sheepItForm_<?php echo $key2 ?>_addtnlcomments').html('<?php echo $value2; ?>');
<?php } ?>
...
{
    ?>
            $('#sheepItForm_<?php echo $key2 ?>_lastevent').val('<?php echo $value2; ?>');
<?php } ?>
...
{
    ?>
            $('#sheepItForm_<?php echo $key3; ?>_ah1').val('<?php echo $value3; ?>');
<?php } ?>
...
{
    ?>
            $('#sheepItForm1_<?php echo $key1 ?>_treatment').val('<?php echo $value1; ?>');
<?php } ?>
<?php
foreach ($wiz_05->frequency1 as $key2 => $value2)
{
    ?>
            $('#sheepItForm1_<?php echo $key2 ?>_frequency').val('<?php echo $value2; ?>');
<?php } ?>
...
{
    ?>
            $('#sheepItForm1_<?php echo $key3 ?>_person').val('<?php echo $value3; ?>');
<?php } ?>
