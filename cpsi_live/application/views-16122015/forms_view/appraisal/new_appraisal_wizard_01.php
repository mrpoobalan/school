...
<!--        <section>
    ...
    <fieldset>
        ...
        <section>
            ...
            <input type="text" id="dob" name="dob" class="textbox" value="<?php echo isset($wiz01->dob) ? $wiz01->dob : ''; ?>">
        </section>
        <section>
        ...
        <section>
            ...
            <div id="sheepItForm" style="float:left">
                <div id="sheepItForm_template">
                    ...
                    <input id="sheepItForm_#index#_contact" name="contactattempt1[]" type="text" class="generate_datepic"/>
