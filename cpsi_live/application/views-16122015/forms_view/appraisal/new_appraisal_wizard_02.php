...
<section class="page">
    ...
    <fieldset class="new-section">
        ...
        <span class="inline hide"><input type="checkbox" onclick="hideSection(366)" id="hide366"  name="hide366" value = "on" <?php echo!empty($wizardData->hide366) && $wizardData->hide366 == 'on' ? ' checked ' : '' ?> /> <label for="hide366"><span></span>No needs at this time</label></span>
        <div class="hide366">
            <?php
    ...
    <fieldset id="background" class="new-section">
        ...
        <section>
            ...
            <span class="inline"><input type="radio" name="milestones" onchange="showvalue26(this.value)" value="milestoneyes" id="m-yes" checked="checked" /> <label for="m-yes"><span></span>Yes</label></span>
            <span class="inline"><input type="radio" name="milestones" onchange="showvalue26(this.value)" value="milestoneno" id="m-no" <?= (!empty($wizardData->milestones) && $wizardData->milestones == "milestoneno") || (!empty($wizardData->milestone) && $wizardData->milestone == 'no') ? ' checked ' : ''; ?>/> <label for="m-no"><span></span>No</label></span>
        ...
        <section>
            ...
            <span class="inline"><input type="radio"  value="yes"  id="complications" onclick="showva75(this.value)" name="complications" <?php if ($wizardData->complications == "yes")
                {
                    ?> checked="checked" <?php } ?> /> <label for="m-yes"><span></span>Yes</label></span>
            <span class="inline"><input type="radio"  value="no" id="complications" onclick="showva75(this.value)"   name="complications" <?php if (empty($wizardData->complications) || $wizardData->complications == "no")
                {
