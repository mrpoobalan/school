...
<?= form_open("{$action}", $attr_FormOpen); ?>
    <fieldset class="new-section">
        ...
        <section>
            ...
            <span class="inline"><input type="radio" name="release1" value="release1yes" id="release1-yes"  onclick="showvalue51(this.value)" <?= $wizardData->release1 == "release1yes" ? ' checked ' : ''; ?> /> <label for="release1-yes"><span></span>Yes</label></span>
            <span class="inline"><input type="radio" name="release1" value="release1no" id="release1-no"  onclick="showvalue51(this.value)" <?= $wizardData->release1 == "release1-no" ? ' checked ' : 'checked'; ?>/> <label for="release1-no"><span></span>No</label></span>
            <div id="hidename51">
    ...
    <fieldset class="new-section">
        ...
        <div class="hideSection8">
            <section>
                ...
                <span class="inline"><input type="radio" name="seizures[]" value="seizuresno" id="seizures-no" <?= !empty($wizardData->seizures) && $wizardData->seizures == 'seizuresno' ? ' checked ' : ''; ?>/> <label for="seizures-no"><span></span>No</label></span>
                <div id="hidename2">
            ...
            <section class="two-col">
                ...
                <span class="inline"><input type="radio" name="ketogenic[]" value="ketogenicyes" id="ketogenicyes" <?= !empty($wizardData->ketogenicyes) ? ' checked ' : ''; ?>/> <label for="ketogenicyes"><span></span> Yes</label></span>
                <span class="inline"><input type="radio" name="ketogenic[]" value="ketogenicno" id="ketogenicno" <?= empty($wizardData->ketogenicno) ? ' checked ' : ''; ?>/> <label for="ketogenicno"><span></span> No</label></span>
...
//                    echo '<pre>'; print_r($treatment); exit;
...
?>
            ...
            <section class="two-col">
                ...
                <span class="inline"><input type="radio" name="shunt" value="shuntyes" id="shuntyes" onclick="showvalue321(this.value)" <?= 'checked'; ?>/> <label for="shunt-yes"><span></span>Yes</label></span>
                <span class="inline"><input type="radio" name="shunt" value="shuntno" id="shuntno" onclick="showvalue321(this.value)" <?= !empty($wizardData->shunt) && $wizardData->shunt == 'shuntno' ? ' checked ' : ''; ?>/> <label for="shunt-no"><span></span>No</label></span>
                <div id="hidename321">
...
foreach ($wizardData->sheepItForm2_med as $key1 => $value1) {
    ?>
                                                                                                                                                                        $('#sheepItForm2_<?php echo $key1 ?>_med').val('<?php echo $value1; ?>');
<?php } ?>
<?php
foreach ($wizardData->sheepItForm2_dos as $key2 => $value2) {
    ?>
                                                                                                                                                                        $('#sheepItForm2_<?php echo $key2 ?>_dos').val('<?php echo $value2; ?>');
<?php } ?>
<?php
foreach ($wizardData->sheepItForm2_route as $key3 => $value3) {
    ?>
                                                                                                                                                                        $('#sheepItForm2_<?php echo $key3 ?>_route').val('<?php echo $value3; ?>');
<?php } ?>
<?php
foreach ($wizardData->sheepItForm2_time as $key4 => $value4) {
    ?>
                                                                                                                                                                        $('#sheepItForm2_<?php echo $key4 ?>_time').val('<?php echo $value4; ?>');
<?php } ?>
...
foreach ($wizardData->sheepItForm3_prnmed as $key1 => $value1) {
    ?>
                                                                                                                                                                        $('#sheepItForm3_<?php echo $key1 ?>_prnmed').val('<?php echo $value1; ?>');
<?php } ?>
<?php
foreach ($wizardData->sheepItForm3_prndos as $key2 => $value2) {
    ?>
                                                                                                                                                                        $('#sheepItForm3_<?php echo $key2 ?>_prndos').val('<?php echo $value2; ?>');
<?php } ?>
<?php
foreach ($wizardData->sheepItForm3_prnroute as $key3 => $value3) {
    ?>
                                                                                                                                                                        $('#sheepItForm3_<?php echo $key3 ?>_prnroute').val('<?php echo $value3; ?>');
<?php } ?>
<?php
foreach ($wizardData->sheepItForm3_prntime as $key4 => $value4) {
    ?>
                                                                                                                                                                        $('#sheepItForm3_<?php echo $key4 ?>_prntime').val('<?php echo $value4; ?>');
<?php } ?>
...
foreach ($wizardData->sheepItForm4_allergy as $key1 => $value1) {
    ?>
                                                                                                                                                                        $('#sheepItForm4_<?php echo $key1 ?>_allergy').val('<?php echo $value1; ?>');
<?php } ?>
<?php
foreach ($wizardData->sheepItForm4_reaction as $key2 => $value2) {
    ?>
                                                                                                                                                                        $('#sheepItForm4_<?php echo $key2 ?>_reaction').html('<?php echo $value2; ?>');
<?php } ?>
<?php
foreach ($wizardData->sheepItForm4_addtnlcomments as $key2 => $value2) {
    ?>
                                                                                                                                                                        $('#sheepItForm4_<?php echo $key2 ?>_addtnlcomments').html('<?php echo $value2; ?>');
<?php } ?>

<?php
foreach ($wizardData->sheepItForm4_lastevent as $key2 => $value2) {
    ?>
                                                                                                                                                                        $('#sheepItForm4_<?php echo $key2 ?>_lastevent').val('<?php echo $value2; ?>');
<?php } ?>

<?php
foreach ($wizardData->sheepItForm4_ah as $key3 => $value3) {
    ?>
                                                                                                                                                                        $('#sheepItForm4_<?php echo $key3; ?>_ah1').val('<?php echo $value3; ?>');
<?php } ?>
...
foreach ($wizardData->sheepItForm5_treatment as $key1 => $value1) {
    ?>
                                                                                                                                                                        $('#sheepItForm5_<?php echo $key1 ?>_treatment').val('<?php echo $value1; ?>');
<?php } ?>
<?php
foreach ($wizardData->sheepItForm5_frequency as $key2 => $value2) {
    ?>
                                                                                                                                                                        $('#sheepItForm5_<?php echo $key2 ?>_frequency').val('<?php echo $value2; ?>');
<?php } ?>
...
foreach ($wizardData->sheepItForm5_person as $key3 => $value3) {
    ?>
                                                                                                                                                                        $('#sheepItForm5_<?php echo $key3 ?>_person').val('<?php echo $value3; ?>');
<?php } ?>
