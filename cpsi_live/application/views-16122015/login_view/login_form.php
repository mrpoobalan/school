...
<section class="login-box">
    ...
    <img src="<?php echo $captcha['image_src']; ?>" alt="CAPTCHA security code" style=" float: left;margin-right: 10px;padding-left: 112px;width: 170px;padding-bottom: 10px;" />
    <img src="<?php echo base_url() . "assets/captcha/refresh1.jpg" ?>" id="imgrefresh">
    <input id="captcha" name="captcha" type="text" style="margin-left: 94px;"/>
    <?php echo form_error(); ?>
