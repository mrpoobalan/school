...
//        exit;
        foreach ($students as $list) {
            ...
            if ($form_staus == 45):
                ...
                $rejected_id = $this->schoolhealth_model->check_assessment_rejected_comments($list->wizard_sif_num, $list->unique_number);
...
//            echo "<pre>";
            ...
            if ($user_role->{'name'} == Nurse && ($list->form_type == "Appraisal" || $list->form_type == "Assessment")):
                ...
                elseif (($list->wizard_status == 5 || $list->wizard_status == 25) && $current_user_id == $this->session->userdata('user_id')):
                    $this->table->add_row(
