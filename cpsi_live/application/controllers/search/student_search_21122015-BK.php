            ...
            if ($user_role->{'name'} == Nurse && $list->form_type == "Appraisal"):
                ...
                elseif ($list->wizard_status == 5 && $current_user_id == $this->session->userdata('user_id')):
                    $this->table->add_row(
                            ...
                            anchor("access_control/admin/form_update/" . $list->wizard_num . "-" . $list->wizard_id . "-" . $list->unique_number, "Edit"), $this->schoolhealth_model->form_status($status = $list->wizard_status), $list->wizard_sif_num, $list->first_name, $list->last_name, date("m/d/y", strtotime($list->birth_date)), $list->student_school, $current_owner, date("m/d/y", strtotime($list->wizard_modified)) . " - " . $submitter->first_name . " " . $submitter->last_name . " - " . $list->form_type, 'N/A', anchor("access_control/admin/audit_trail/" . $list->wizard_num . "-" . $list->wizard_id . "-" . $list->unique_number . "/res", "View Alltest2")
                    );
                else:
                    $this->table->add_row(
                            anchor("access_control/admin/form_view/" . $list->wizard_num . "-" . $list->wizard_id . "-" . $list->unique_number, "View") .
                            " ", $this->schoolhealth_model->form_status($status = $list->wizard_status), $list->wizard_sif_num, $list->first_name, $list->last_name, date("m/d/y", strtotime($list->birth_date)), $list->student_school, $current_owner, date("m/d/y", strtotime($list->wizard_modified)) . " - " . $submitter->first_name . " " . $submitter->last_name . " - " . $list->form_type, 'N/A', anchor("access_control/admin/audit_trail/" . $list->wizard_num . "-" . $list->wizard_id . "-" . $list->unique_number . "/res", "View Alltest3")
                    );
                endif;

            elseif ($sel <> 0 || $user_role->{'name'} <> Nurse):

                if (in_array($sifnumber, $latest_assessment_sif) && $xcount == 0 && $list->wizard_status == 45 && $list->form_type <> "Appraisal"):

                    $this->table->add_row(
                            anchor("access_control/admin/form_view/" . $list->wizard_num . "-" . $list->wizard_id . "-" . $list->unique_number, "View"), $this->schoolhealth_model->form_status($status = $list->wizard_status), $list->wizard_sif_num, $list->first_name, $list->last_name, date("m/d/y", strtotime($list->birth_date)), $list->student_school, $current_owner, date("m/d/y", strtotime($list->wizard_modified)) . " - " . $submitter->first_name . " " . $submitter->last_name . " - " . $list->form_type, anchor("access_control/admin/form_copy/assessment_wiz16_" . $sifnumber . "-" . $list->wizard_id . "-" . $list->unique_number, "Assessment") . " " . anchor("access_control/admin/form_copy/appraisal_wiz06_" . $sifnumber . "-" . $list->wizard_id . "-" . $list->unique_number, "Appraisal"), anchor("access_control/admin/audit_trail/" . $list->wizard_num . "-" . $list->wizard_id . "-" . $list->unique_number . "/res", "View Alltest4")
                    );
                elseif ($list->wizard_status == 5 && $current_user_id == $this->session->userdata('user_id')):
                    $this->table->add_row(
                            anchor("access_control/admin/form_view/" . $list->wizard_num . "-" . $list->wizard_id . "-" . $list->unique_number, "View") . " | " .
                            anchor("access_control/admin/form_update/" . $list->wizard_num . "-" . $list->wizard_id . "-" . $list->unique_number, "Edit"), $this->schoolhealth_model->form_status($status = $list->wizard_status), $list->wizard_sif_num, $list->first_name, $list->last_name, date("m/d/y", strtotime($list->birth_date)), $list->student_school, $current_owner, date("m/d/y", strtotime($list->wizard_modified)) . " - " . $submitter->first_name . " " . $submitter->last_name . " - " . $list->form_type, 'N/A', anchor("access_control/admin/audit_trail/" . $list->wizard_num . "-" . $list->wizard_id . "-" . $list->unique_number . "/res", "View Alltest5")
                    );
                ...
                elseif ($list->wizard_status <> 45 && $user_role->{'name'} == Nurse && $current_user_id == $this->session->userdata('user_id')):
                    $this->table->add_row(
                            ...
                            . " - " . $submitter->first_name . " " . $submitter->last_name . " - " . $list->form_type, 'N/A', anchor("access_control/admin/audit_trail/" . $list->wizard_num . "-" . $list->wizard_id . "-" .
                                    $list->unique_number . "/res", "View Alltest6")
                    );
                ...
                elseif ($list->wizard_status == 45 && $user_role->{'name'} == Nurse && $current_user_id == $this->session->userdata('user_id')):
                    $this->table->add_row(
                            ...
                            anchor("access_control/admin/form_update/" . $list->wizard_num . "-" . $list->wizard_id . "-" . $list->unique_number, "Edit"), $this->schoolhealth_model->form_status($status = $list->wizard_status), $list->wizard_sif_num, $list->first_name, $list->last_name, date("m/d/y", strtotime($list->birth_date)), $list->student_school, $current_owner, date("m/d/y", strtotime($list->wizard_modified))
                            . " - " . $submitter->first_name . " " . $submitter->last_name . " - " . $list->form_type, 'N/A', anchor("access_control/admin/audit_trail/" . $list->wizard_num . "-" . $list->wizard_id . "-" .
                                    $list->unique_number . "/res", "View Alltest7")
                    );
                elseif ($list->wizard_status <> 45 && $list->wizard_status <> 5 && $user_role->{'name'} <> Nurse && $current_user_id == $this->session->userdata('user_id')):
                    $this->table->add_row(
                            ...
                            anchor("access_control/admin/form_update/" . $list->wizard_num . "-" . $list->wizard_id . "-" . $list->unique_number, "Edit"), $this->schoolhealth_model->form_status($status = $list->wizard_status), $list->wizard_sif_num, $list->first_name, $list->last_name, date("m/d/y", strtotime($list->birth_date)), $list->student_school, $current_owner, date("m/d/y", strtotime($list->wizard_modified))
                            . " - " . $submitter->first_name . " " . $submitter->last_name . " - " . $list->form_type, 'N/A', anchor("access_control/admin/audit_trail/" . $list->wizard_num . "-" . $list->wizard_id . "-" .
                                    $list->unique_number . "/res", "View Alltest8")
                    );

                else:
                    $this->table->add_row(
                            anchor("access_control/admin/form_view/" . $list->wizard_num . "-" . $list->wizard_id . "-" . $list->unique_number, "View"), $this->schoolhealth_model->form_status($status = $list->wizard_status), $list->wizard_sif_num, $list->first_name, $list->last_name, date("m/d/y", strtotime($list->birth_date)), $list->student_school, $current_owner, date("m/d/y", strtotime($list->wizard_modified)) . " - " . $submitter->first_name . " " . $submitter->last_name . " - " . $list->form_type, 'N/A', anchor("access_control/admin/audit_trail/" . $list->wizard_num . "-" . $list->wizard_id . "-" . $list->unique_number . "/res", "View All6")
                    );
                endif;

            elseif (in_array($sifnumber, $latest_assessment_sif) && $xcount == 0 && $list->wizard_status == 45 && $list->form_type <> "Appraisal"):
                $this->table->add_row(
