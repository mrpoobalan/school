...
// get user details
            ...
            $error_msg = "You are unauthorized user";
    ...
    function validate_credentials() {
        ...
        if ($captcha_info != $captcha_value) {
            //$this->session->set_flashdata('captcha_error', 'Captcha was not correct');
            $query = null;
...
// validation rules
    function _set_rules_login() {
        $this->form_validation->set_rules(
                'current_password', 'Current Password', 'trim|required|min_length[6]|max_length[32]|xss_clean');
